...
import { SignUpForm } from "@/app/components/auth/AuthForms";
            ...
            >
                ...
                <div className="rounded-3xl border border-gray-100 bg-white/80 p-8 shadow-2xl backdrop-blur-xl dark:border-white/10 dark:bg-black/80">
                    <div className="mb-8 text-center">
                        <h1 className="text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Бүртгэл үүсгэх</h1>
                        <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">
                            Дижитал менюгээ өнөөдрөөс эхлүүлээрэй. ⭐
                        </p>
                    </div>
